...
def render_template() -> dict[str, Any]:
    template = {
        ...
        "Resources": {
            "LandingBucket": {
                ...
                "Properties": {
                    ...
                    "LifecycleConfiguration": {"Rules": [
                        {"Id": "expire-raw", "Status": "Enabled", "Prefix": "s3-uploader-v2/uploads/", "ExpirationInDays": 1, "NoncurrentVersionExpiration": {"NoncurrentDays": 1}},
                        {"Id": "expire-prepared", "Status": "Enabled", "Prefix": "s3-uploader-v2/jobs/", "ExpirationInDays": 30, "NoncurrentVersionExpiration": {"NoncurrentDays": 30}},
                    ]},
                },
            },
            ...
            "MutationQueue": {"Type": "AWS::SQS::Queue", "Properties": {"FifoQueue": True, "ContentBasedDeduplication": False, "QueueName": "s3-uploader-v3-mutations.fifo", "VisibilityTimeout": 120, "RedrivePolicy": {"deadLetterTargetArn": {"Fn::GetAtt": ["DeadLetterQueue", "Arn"]}, "maxReceiveCount": 5}}},
            ...
            "MutationDispatcherTaskDefinition": {"Type": "AWS::ECS::TaskDefinition", "Properties": {"Family": "s3-uploader-v3-mutation-dispatcher", "RequiresCompatibilities": ["FARGATE"], "NetworkMode": "awsvpc", "Cpu": "512", "Memory": "1024", "ExecutionRoleArn": {"Fn::GetAtt": ["ExecutionRole", "Arn"]}, "TaskRoleArn": {"Fn::GetAtt": ["WorkerTaskRole", "Arn"]}, "ContainerDefinitions": [{"Name": "dispatcher", "Image": {"Ref": "WorkerImageUri"}, "Essential": True, "Command": ["python3", "-m", "s3tables_uploader_v2.mutation_dispatcher"], "Environment": [{"Name": "AWS_REGION", "Value": {"Ref": "AWS::Region"}}, {"Name": "S3_UPLOADER_V2_LANDING_BUCKET", "Value": {"Ref": "LandingBucket"}}, {"Name": "S3_UPLOADER_V3_MUTATION_QUEUE_URL", "Value": {"Ref": "MutationQueue"}}, {"Name": "S3_UPLOADER_V2_GLUE_JOB_NAME", "Value": "ah-soc-delta-pilot-web-ingest"}, {"Name": "S3_UPLOADER_V3_MAX_CONCURRENT_GLUE", "Value": "5"}, {"Name": "S3_UPLOADER_V3_MAX_TRACKED_MUTATIONS", "Value": "50"}, {"Name": "S3_UPLOADER_V3_MUTATION_VISIBILITY_SECONDS", "Value": "120"}, {"Name": "S3_UPLOADER_V3_MUTATION_VISIBILITY_RENEWAL_SECONDS", "Value": "30"}, {"Name": "S3_UPLOADER_V3_MUTATION_POLL_SECONDS", "Value": "10"}], "LogConfiguration": {"LogDriver": "awslogs", "Options": {"awslogs-group": {"Ref": "WorkerLogGroup"}, "awslogs-region": {"Ref": "AWS::Region"}, "awslogs-stream-prefix": "dispatcher"}}}]}},
            "MutationDispatcherService": {"Type": "AWS::ECS::Service", "Properties": {"Cluster": {"Ref": "ClusterArn"}, "DesiredCount": 1, "LaunchType": "FARGATE", "TaskDefinition": {"Ref": "MutationDispatcherTaskDefinition"}, "NetworkConfiguration": {"AwsvpcConfiguration": {"AssignPublicIp": "ENABLED", "SecurityGroups": [{"Ref": "ApiSecurityGroup"}], "Subnets": {"Ref": "PrivateSubnets"}}}}},
            "MutationQueueDlqAlarm": {"Type": "AWS::CloudWatch::Alarm", "Properties": {"AlarmDescription": "S3 uploader Glue mutation messages reached the DLQ", "Namespace": "AWS/SQS", "MetricName": "ApproximateNumberOfMessagesVisible", "Dimensions": [{"Name": "QueueName", "Value": {"Fn::GetAtt": ["DeadLetterQueue", "QueueName"]}}], "Statistic": "Maximum", "Period": 60, "EvaluationPeriods": 1, "Threshold": 0, "ComparisonOperator": "GreaterThanThreshold", "TreatMissingData": "notBreaching"}},
    ...
    resources["V3GlueMutationReleasePolicy"] = {
        "Type": "AWS::IAM::Policy",
        "Properties": {
            "PolicyName": "s3-uploader-v3-mutation-release",
            "Roles": [{"Fn::Sub": "ah-soc-delta-pilot-glue-role"}],
            "PolicyDocument": {"Version": "2012-10-17", "Statement": [{
                "Effect": "Allow", "Action": ["s3:GetObject", "s3:DeleteObject"],
                "Resource": [
                    {"Fn::Sub": "${LandingBucket.Arn}/s3-uploader-v2/table-locks/*"},
                    {"Fn::Sub": "${LandingBucket.Arn}/s3-uploader-v2/table-queues/*"},
                ],
            }]},
        },
    }
    ...
    api_sqs_statement = next(statement for statement in api_statements if statement["Action"] == "sqs:SendMessage")
    api_sqs_statement["Resource"].append({"Fn::GetAtt": ["MutationQueue", "Arn"]})
    worker_statements = resources["WorkerTaskRole"]["Properties"]["Policies"][0]["PolicyDocument"]["Statement"]
    worker_statements.extend([
        {
            "Effect": "Allow",
            "Action": ["sqs:ReceiveMessage", "sqs:DeleteMessage", "sqs:ChangeMessageVisibility", "sqs:GetQueueAttributes"],
            "Resource": {"Fn::GetAtt": ["MutationQueue", "Arn"]},
        },
        {"Effect": "Allow", "Action": ["glue:GetJobRun", "glue:GetJobRuns"], "Resource": v3_job_arn},
        {
            # The dispatcher reconstructs active table locks on startup.
            # Include the prefix itself as well as its objects: S3 evaluates
            # ListObjectsV2's requested prefix before object access.
            "Effect": "Allow", "Action": "s3:ListBucket", "Resource": {"Fn::GetAtt": ["LandingBucket", "Arn"]},
            "Condition": {"StringLike": {"s3:prefix": ["s3-uploader-v2/table-locks", "s3-uploader-v2/table-locks/*"]}},
        },
    ])
    ...
    for task_definition in ("ApiTaskDefinition", "WorkerTaskDefinition", "BaseWorkerTaskDefinition"):
        ...
        for variable in environment:
            if variable["Name"] == "S3_UPLOADER_V2_GLUE_JOB_NAME":
                ...
                break
    resources["ApiTaskDefinition"]["Properties"]["ContainerDefinitions"][0]["Environment"].append(
        {"Name": "S3_UPLOADER_V3_MUTATION_QUEUE_URL", "Value": {"Ref": "MutationQueue"}}
    )
    dispatcher_environment = resources["MutationDispatcherTaskDefinition"]["Properties"]["ContainerDefinitions"][0]["Environment"]
    for variable in dispatcher_environment:
        if variable["Name"] == "S3_UPLOADER_V2_GLUE_JOB_NAME":
            variable["Value"] = {"Ref": "V3GlueJob"}
            break
    return template
