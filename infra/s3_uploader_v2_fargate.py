...
def render_template() -> dict[str, Any]:
    return {
        ...
        "Resources": {
            ...
            "ApiService": {"Type": "AWS::ECS::Service", "Properties": {"Cluster": {"Ref": "ClusterArn"}, "DesiredCount": 1, "LaunchType": "FARGATE", "TaskDefinition": {"Ref": "ApiTaskDefinition"}, "NetworkConfiguration": {"AwsvpcConfiguration": {"AssignPublicIp": "DISABLED", "SecurityGroups": [{"Ref": "ApiSecurityGroup"}], "Subnets": {"Ref": "PrivateSubnets"}}}, "LoadBalancers": [{"ContainerName": "api", "ContainerPort": 8090, "TargetGroupArn": {"Ref": "ApiTargetGroup"}}]}},
