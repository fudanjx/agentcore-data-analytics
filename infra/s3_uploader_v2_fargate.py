...
def render_template() -> dict[str, Any]:
    return {
        ...
        "Resources": {
            ...
            "WorkerTaskRole": {"Type": "AWS::IAM::Role", "Properties": {"AssumeRolePolicyDocument": {"Version": "2012-10-17", "Statement": [{"Effect": "Allow", "Principal": {"Service": "ecs-tasks.amazonaws.com"}, "Action": "sts:AssumeRole"}]}, "Policies": [{"PolicyName": "worker-data", "PolicyDocument": {"Version": "2012-10-17", "Statement": [{"Effect": "Allow", "Action": ["s3:GetObject", "s3:GetObjectVersion", "s3:PutObject"], "Resource": [{"Fn::GetAtt": ["LandingBucket", "Arn"]}, {"Fn::Sub": "${LandingBucket.Arn}/*"}]}, {"Effect": "Allow", "Action": "s3:ListBucket", "Resource": {"Fn::GetAtt": ["LandingBucket", "Arn"]}, "Condition": {"StringLike": {"s3:prefix": ["jobs/*", "sessions/*"]}}}, {"Effect": "Allow", "Action": ["s3:GetObject", "s3:PutObject"], "Resource": "arn:aws:s3:::ah-data-analytics/temp_s3_update/web_ingest/table_contracts/*"}, {"Effect": "Allow", "Action": "glue:StartJobRun", "Resource": {"Fn::Sub": "arn:${AWS::Partition}:glue:${AWS::Region}:${AWS::AccountId}:job/ah-soc-delta-pilot-web-ingest"}}, {"Effect": "Allow", "Action":"secretsmanager:GetSecretValue", "Resource": {"Ref": "EncryptionSecretArn"}}]}}]}},
